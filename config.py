...
sklmethods = {
    ...
    'mlp-relu1': MLPClassifier(hidden_layer_sizes=(350), alpha=0.001, batch_size=100000,
            learning_rate='adaptive', power_t=0.5, max_iter=2000, shuffle=False, random_state=None,
            tol=0.000001, warm_start=True, momentum=0.7, nesterovs_momentum=False,
            early_stopping=False, validation_fraction=0.9, beta_1=0.9, beta_2=0.999, epsilon=1e-08,
            activation='relu', solver='sgd', learning_rate_init=0.95, verbose=True),
    'mlp-relu2': MLPClassifier(hidden_layer_sizes=(100), alpha=0.001, batch_size=2000,
    ...
    'mlp-relu3': MLPClassifier(hidden_layer_sizes=(100), alpha=0.001, batch_size=2000,
            learning_rate='adaptive', power_t=0.5, max_iter=2000, shuffle=True, random_state=None,
            tol=0.000001, warm_start=False, momentum=0.9, nesterovs_momentum=True,
            early_stopping=True, validation_fraction=0.90, beta_1=0.9, beta_2=0.999, epsilon=1e-08,
            activation='relu', solver='lbfgs', learning_rate_init=0.75, verbose=True),
    # MLPClassifier with logistic activation function:
    'mlp-logistic1': MLPClassifier(hidden_layer_sizes=(100), alpha=0.001, batch_size=2000,
            learning_rate='adaptive', power_t=0.5, max_iter=2000, shuffle=True, random_state=None,
            tol=0.000001, warm_start=False, momentum=0.9, nesterovs_momentum=True,
            early_stopping=True, validation_fraction=0.90, beta_1=0.9, beta_2=0.999, epsilon=1e-08,
            activation='logistic', solver='adam', learning_rate_init=0.75, verbose=True),
    'mlp-logistic2': MLPClassifier(hidden_layer_sizes=(100), alpha=0.001, batch_size=2000,
            learning_rate='adaptive', power_t=0.5, max_iter=2000, shuffle=True, random_state=None,
            tol=0.000001, warm_start=False, momentum=0.9, nesterovs_momentum=True,
            early_stopping=True, validation_fraction=0.90, beta_1=0.9, beta_2=0.999, epsilon=1e-08,
            activation='logistic', solver='sgd', learning_rate_init=0.75, verbose=True),
    'mlp-logistic3': MLPClassifier(hidden_layer_sizes=(100), alpha=0.001, batch_size=2000,
            learning_rate='adaptive', power_t=0.5, max_iter=2000, shuffle=True, random_state=None,
            tol=0.000001, warm_start=False, momentum=0.9, nesterovs_momentum=True,
            early_stopping=True, validation_fraction=0.90, beta_1=0.9, beta_2=0.999, epsilon=1e-08,
    ...
    'sgd-modhuber': SGDClassifier(alpha=0.0001, average=False, epsilon=0.05, eta0=0.0025,
            ...
            random_state=None, shuffle=False, tol=None, warm_start=False,
