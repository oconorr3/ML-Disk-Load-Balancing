...
# clf = PassiveAggressiveClassifier(C=1.0, fit_intercept=False, max_iter=None, tol=0.000001, shuffle=True, verbose=1,
#                  loss='squared_hinge', n_jobs=60, random_state=None, warm_start=False, class_weight=None, average=False, n_iter=200)
from sklearn.linear_model import SGDClassifier
clf = SGDClassifier(alpha=0.0001, average=False, epsilon=0.05, eta0=0.0025,
       fit_intercept=False, l1_ratio=0.10, learning_rate='invscaling',
       loss='hinge', max_iter=50, penalty='elasticnet', n_jobs=-1,
       power_t=0.05, random_state=None, shuffle=True, tol=None,
